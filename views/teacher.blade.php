...
@section('content')
        ...
        <div class="add-section my-2">
          ...
          <a href="{{ url('/teacher/trash') }}" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Trash</a>
        </div>
        ...
        <div class="table-responsive" id="printelement">
          <table id="myTable" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <button type="button" class="btn btn-sm btn-primary my-1" title="View" data-bs-toggle="modal"
                    data-bs-target="#teacherView{{ $teacher->id }}">
                    <i class="bi bi-zoom-in icon icon-left"></i>
                  </button>
                  @if (session('Admin_Login_id'))
                  <button data-bs-toggle="modal" data-bs-target="#teacherEdit{{ $teacher->id }}" class="btn btn-sm btn-info my-1"
                    title="Edit">
                    <i class="bi bi-pencil-square icon icon-left"></i>
                  </button>
                  <a href="{{ url('/teacher_delete/'.$teacher->id) }}" class="btn btn-danger btn-sm my-1"
              ...
              <div class="modal fade" id="teacherView{{ $teacher->id }}">
                <div class="modal-dialog modal-dialog-centered modal-fullscreen" role="document">
                  <div class="modal-content" >
                    ...
                    <div class="modal-body" id="detailsprint{{ $teacher->id }}">
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                              <img src="{{ asset('storage/teacher/'.$teacher->photo) }}" alt="Admin" class="rounded-circle" width="150" height="150">
                              <div class="mt-3">
                                <h4>{{ $teacher->name }}</h4>
                                <p class="text-secondary mb-1">{{ $teacher->qualification.' '.$teacher->department }}</p>
                        ...
                        <div class="card mb-3">
                          <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-9 text-secondary">{{ $teacher->department }}</div>
                            </div>
                            <hr>
                            <div class="row">
                              <div class="col-sm-3">
                              ...
                              <div class="col-sm-9 text-secondary">{{ $teacher->qualification }}</div>
                            </div>
                            <hr>
                            <div class="row">
                              <div class="col-sm-3">
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-9 text-secondary">{{ $teacher->address }}</div>
                            </div>
                            <hr>
                          </div>
                        </div>
                    ...
                    <div class="modal-footer">
                      <button class="btn btn-primary" onclick="detailsprint({{ $teacher->id }})">
                        <i class="bi bi-printer btn-icon"></i> Print
                      </button>
              ...
              <!-- edit Teacher -->
              <div class="modal fade" id="teacherEdit{{ $teacher->id }}">
                    ...
                    <form action="{{ url('/teacher_edit/'.$teacher->id) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="border-1">
                              <img src="{{ asset('storage/student/'.$teacher->photo) }}" width="50" height="50" id="output">
                            ...
                            <div class="form-group">
                              ...
                              <select name="department" class="form-select">
                                ...
                                <option value="{{ $departments->name }}"
                                    @if ($departments->name == $teacher->department)
                                    selected
