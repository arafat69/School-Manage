...
<?php $__env->startSection('content'); ?>
    <div class="page-title">
        ...
        <div class="add-section my-2">
          <a href="<?php echo e(url('/add-student')); ?>" class="btn btn-primary"><i class="bi bi-person-plus btn-icon"></i> Add New Student</a>
          <button class="btn btn-success" onclick="myprintelement()">
            <i class="bi bi-printer btn-icon"></i> Print
          </button>
          <a href="<?php echo e(url('/student/trash')); ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Trash</a>
        </div>
        ...
        <div class="table-responsive" id="printelement">
          <table id="myTable" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <button type="button" class="btn btn-sm btn-primary my-1" title="View" data-bs-toggle="modal"
                    data-bs-target="#studentView<?php echo e($student->id); ?>">
                    <i class="bi bi-zoom-in icon icon-left"></i>
                  </button>
                  <?php if(session('Admin_Login_id')): ?>
                  <button data-bs-toggle="modal" data-bs-target="#StudentEdit<?php echo e($student->id); ?>" class="btn btn-sm btn-info my-1"
                    title="Edit">
                    <i class="bi bi-pencil-square icon icon-left"></i>
                  </button>
                  <a href="<?php echo e(url('/student_delete/'.$student->id)); ?>" class="btn btn-danger btn-sm my-1" onclick="return confirm('Are You Sure! Delete This..')"
                    title="Delete">
              ...
              <div class="modal fade" id="studentView<?php echo e($student->id); ?>">
                <div class="modal-dialog modal-dialog-centered modal-fullscreen" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body" id="detailsprint<?php echo e($student->id); ?>">
                          ...
                          <div class="card">
                            <div class="card-body">
                              <div class="d-flex flex-column align-items-center text-center">
                                <img src="<?php echo e(asset('storage/student/'.$student->photo)); ?>" alt="Admin" class="rounded-circle" width="150" height="150">
                                <div class="mt-3">
                                  <h4><?php echo e($student->name); ?></h4>
                                  <p class="text-secondary mb-1"><?php echo e($student->department.' '.$student->semester.' '.'Semester'); ?></p>
                          ...
                          <div class="card mb-3">
                            <div class="card-body">
                              <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->name); ?></div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->father); ?></div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->mother); ?></div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->roll); ?> </div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->reg); ?></div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->department); ?></div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->semester.' - '.$student->shift); ?> </div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->session); ?> </div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->phone); ?></div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"> <?php echo e($student->email); ?></div>
                              </div>
                              <hr class="my-2">
                              <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary"><?php echo e($student->address); ?></div>
                              </div>
                              <hr class="my-2">
                            </div>
                          </div>
                    ...
                    <div class="modal-footer">
                      <button class="btn btn-primary" onclick="detailsprint(<?php echo e($student->id); ?>)">
                        <i class="bi bi-printer btn-icon"></i> Print
                      </button>
              ...
              <!-- edit student -->
              <div class="modal fade" id="StudentEdit<?php echo e($student->id); ?>">
                <div class="modal-dialog modal-dialog-centered modal-fullscreen" role="document">
                  <div class="modal-content">
                    ...
                    <form action="<?php echo e(url('/student_edit/'.$student->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="border-1">
                              <img src="<?php echo e(asset('storage/student/'.$student->photo)); ?>" width="50" height="50" id="output">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="father" value="<?php echo e($student->father); ?>">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label for="" class="fw-bold">Mother Name</label>
                              <input type="text" class="form-control" name="mother" value="<?php echo e($student->mother); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="roll" value="<?php echo e($student->roll); ?>">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label for="" class="fw-bold">Reg Number</label>
                              <input type="text" class="form-control" name="reg" value="<?php echo e($student->reg); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group">
                              ...
                              <select name="department" class="form-select">
                                ...
                                <option value="<?php echo e($departments->name); ?>"
                                    <?php if($departments->name == $student->department): ?>
                                    selected
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <select name="semester" class="choices form-select">
                                <option selected value="<?php echo e($student->semester); ?>"><?php echo e($student->semester); ?></option>
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <select name="shift" class="form-select">
                                <option selected value="<?php echo e($student->shift); ?>"><?php echo e($student->shift); ?></option>
                                <option value="1st">1st</option>
                                <option value="2nd">2nd</option>
                              </select>
                            </div>
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="session" class="form-control" value="<?php echo e($student->session); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              ...
                              <input type="number" name="phone" class="form-control" value="<?php echo e($student->phone); ?>">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
