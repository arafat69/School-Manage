                ...
                <div class="px-3">
                  <div class="row">
                    ...
                    <div class="col-6 text-center">
                      <p class="mb-0 pb-0" style="font-size: 30px"><?php echo e($totalstudent); ?></p>
                      <span class="" style="font-size: 12px">Total</span>
                    </div>
                  </div>
                </div>
                <div class="card-footer bg-light p-0">
                  <a href="<?php echo e(url('/student')); ?>" class="text-white d-block p-2">View Student <i class="bi bi-box-arrow-in-right"></i></a>
                </div>
              </div>
            </div>
              ...
              <div class="card text-primary">
                ...
                <div class="px-3">
                  <div class="row">
                    ...
                    <div class="col-6 text-center">
                      <p class="mb-0 pb-0" style="font-size: 30px"><?php echo e($totalteacher); ?></p>
                      <span class="" style="font-size: 12px">Total</span>
                    </div>
                  </div>
                </div>
                <div class="card-footer bg-light p-0">
                  <a href="<?php echo e(url('/teacher')); ?>" class="text-white d-block p-2">View Teacher <i class="bi bi-box-arrow-in-right"></i></a>
                </div>
              </div>
            </div>
              ...
              <div class="card text-success">
                ...
                <div class="px-3">
                  <div class="row">
                    ...
                    <div class="col-6 text-center">
                      <p class="mb-0 pb-0" style="font-size: 30px"><?php echo e($totaldepartment); ?></p>
                      <span class="" style="font-size: 12px">Total</span>
                    </div>
                  </div>
                </div>
                <div class="card-footer bg-light p-0">
                  <a href="<?php echo e(url('/department')); ?>" class="text-white d-block p-2">View Department <i class="bi bi-box-arrow-in-right"></i></a>
                </div>
              </div>
            </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Xampp\htdocs\schoolmanagement\resources\views//dashboard.blade.php ENDPATH**/ ?>